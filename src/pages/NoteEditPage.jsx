...
const NoteEditPage = () => {
    ...
    const onClickHandler = async (event) => {
        ...
        try {
            ...
            await httpRequestAxiosQueueUtility.put(editNoteUrl, noteData)
            // increasing the progress bar value
            setProgressBar((prevState) => ({
                show: true,
                width: 75
...
// we are exporting the value returned by this "IsAuthenticatedPage(NoteEditPage)" HOC(HIGHER-ORDER-FUNCTION) function This function returns a new function which will encapsulate this NoteEditPage component in it and also have the capability of authenticating the user before rendering this NoteEditPage
export default IsAuthenticatedPage(NoteEditPage)