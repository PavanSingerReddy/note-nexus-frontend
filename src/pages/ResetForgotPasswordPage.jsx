            ...
            <div className="mx-3 flex justify-center items-center h-[90vh] flex-col text-xs sm:text-sm md:text-base">
                <form className="flex flex-col items-start">
                    ...
                    <div className='relative mb-5 min-w-full'>
                        ...
                        <p className={`mt-2 absolute text-sm text-green-500 ${passwordValidation.isClicked && passwordValidation.isNewPasswordValid && passwordValidation.doesNewPasswordAndReEnteredNewPasswordMatch ? "" : "invisible"}`}>New Password is valid</p>
                        {/* if isClicked is true and isNewPasswordValid is false then we render the "New Password Must not be blank" paragraph */}
                        <p className={`mt-2 absolute top-0 text-sm text-red-500 ${passwordValidation.isClicked && !passwordValidation.isNewPasswordValid ? "" : "invisible"}`}>New Password Must not be blank</p>
                        ...
                        <p className={`mt-2 absolute top-0 text-sm text-red-500 ${passwordValidation.isClicked && passwordValidation.isNewPasswordValid && !passwordValidation.doesNewPasswordAndReEnteredNewPasswordMatch ? "" : "invisible"}`}>Passwords do not match</p>
                    </div>
                    ...
                    <div className='relative mb-8 min-w-full'>
                        ...
                        <p className={`mt-2 absolute text-sm text-green-500 ${passwordValidation.isClicked && passwordValidation.isReEnterdNewPasswordValid && passwordValidation.doesNewPasswordAndReEnteredNewPasswordMatch ? "" : "invisible"}`}>Re-entered New Password is valid</p>
                        ...
                        <p className={`mt-2 absolute top-0 text-sm text-red-500 ${passwordValidation.isClicked && !passwordValidation.isReEnterdNewPasswordValid ? "" : "invisible"}`}>Re-entered New Password Must not be blank</p>
                        ...
                        <p className={`mt-2 absolute top-0 text-sm text-red-500 ${passwordValidation.isClicked && passwordValidation.isReEnterdNewPasswordValid && !passwordValidation.doesNewPasswordAndReEnteredNewPasswordMatch ? "" : "invisible"}`}>Passwords do not match</p>
                    </div>
                </form>
