                    ...
                    <div className="m-3 flex justify-center items-center h-screen flex-col text-xs sm:text-sm md:text-base">
                        <form className="flex flex-col items-start">
                            ...
                            <div className='relative mb-5'>
                                ...
                                <p className={`mt-2 min-w-[90vw] absolute text-sm text-green-500 ${passwordValidation.isClicked && passwordValidation.isOldPasswordValid ? "" : "invisible"}`}>Old Password is valid</p>
                                {/* if isClicked is true and isOldPasswordValid is false then we render the "Old Password Must not be blank" paragraph */}
                                <p className={`mt-2 min-w-[90vw] absolute top-0 text-sm text-red-500 ${passwordValidation.isClicked && !passwordValidation.isOldPasswordValid ? "" : "invisible"}`}>Old Password Must not be blank</p>
                            </div>
                            {/* new password input */}
