            ...
            <div className="flex flex-col h-[calc(100dvh)]">
                ...
                <div className="mx-3 flex justify-center items-center h-[calc(100dvh)] flex-col text-xs sm:text-sm md:text-base">
                    <form className="flex flex-col items-start">
                        ...
                        <div className='relative mb-5 min-w-full'>
                            {/* if isClicked is true and isOldPasswordValid is true then we render the "Old Password is valid" paragraph */}
                            <p className={`m-2 absolute text-sm text-green-500 ${passwordValidation.isClicked && passwordValidation.isOldPasswordValid ? "" : "invisible"}`}>Old Password is valid</p>
                            {/* if isClicked is true and isOldPasswordValid is false then we render the "Old Password Must not be blank" paragraph */}
                            <p className={`m-2 absolute top-0 text-sm text-red-500 ${passwordValidation.isClicked && !passwordValidation.isOldPasswordValid ? "" : "invisible"}`}>Old Password Must not be blank</p>
                        </div>
                        {/* new password input */}
                        ...
                        <div className='relative mb-5 min-w-full'>
                            ...
                            <p className={`m-2 absolute text-sm text-green-500 ${passwordValidation.isClicked && passwordValidation.isNewPasswordValid && passwordValidation.doesNewPasswordAndReEnteredNewPasswordMatch ? "" : "invisible"}`}>New Password is valid</p>
                            {/* if isClicked is true and isNewPasswordValid is false then we render the "New Password Must not be blank" paragraph */}
                            <p className={`m-2 absolute top-0 text-sm text-red-500 ${passwordValidation.isClicked && !passwordValidation.isNewPasswordValid ? "" : "invisible"}`}>New Password Must not be blank</p>
                            ...
                            <p className={`m-2 absolute top-0 text-sm text-red-500 ${passwordValidation.isClicked && passwordValidation.isNewPasswordValid && !passwordValidation.doesNewPasswordAndReEnteredNewPasswordMatch ? "" : "invisible"}`}>Passwords do not match</p>
                        </div>
                        ...
                        <div className='relative mb-8 min-w-full'>
                            ...
                            <p className={`m-2 absolute text-sm text-green-500 ${passwordValidation.isClicked && passwordValidation.isReEnterdNewPasswordValid && passwordValidation.doesNewPasswordAndReEnteredNewPasswordMatch ? "" : "invisible"}`}>Re-entered New Password is valid</p>
                            ...
                            <p className={`m-2 absolute top-0 text-sm text-red-500 ${passwordValidation.isClicked && !passwordValidation.isReEnterdNewPasswordValid ? "" : "invisible"}`}>Re-entered New Password Must not be blank</p>
                            ...
                            <p className={`m-2 absolute top-0 text-sm text-red-500 ${passwordValidation.isClicked && passwordValidation.isReEnterdNewPasswordValid && !passwordValidation.doesNewPasswordAndReEnteredNewPasswordMatch ? "" : "invisible"}`}>Passwords do not match</p>
                        </div>
                    </form>
...
// we are exporting the value returned by this "IsAuthenticatedPage(ChangePasswordPage)" HOC(HIGHER-ORDER-FUNCTION) function This function returns a new function which will encapsulate this ChangePasswordPage component in it and also have the capability of authenticating the user before rendering this ChangePasswordPage
export default IsAuthenticatedPage(ChangePasswordPage)