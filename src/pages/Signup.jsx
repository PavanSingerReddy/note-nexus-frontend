...
const Signup = () => {
  ...
  const handleOnSubmit = async (event) => {
    ...
    // checking if the isEmailValid,isUserNameValid,isPasswordValid,isReEnteredPassword and doesPasswordAndReEnteredPasswordMatch if all of them are true then only we perform the signup functionality
  ...
  // if the user clicked on the signup button then isClicked will be true and if the user's email id is valid then isEmailValid also becomes true.And Then if all of these two conditions satisfy then we change the border color to green
  ...
  // if the user clicked on the signup button then isClicked will be true and if the user's username is not blank then isUserNameValid is also becomes true.And Then if all of these two conditions satisfy then we change the border color to green
  if (formValidation.isClicked && formValidation.isUserNameValid) {
    userNameBorderColor = 'green'
  }
  // else if the user clicks on the signup button and the isUserNameValid is not valid then border color becomes red
  ...
  // if the user clicked on the signup button then isClicked will be true and if the user's password is not blank then isPasswordValid will also becomes true and if both the password and Re-entered password match then doesPasswordAndReEnteredPasswordMatch becomes true.And Then if all three of these conditions satisfy then we change the border color to green
  ...
  // else if the user clicks on the signup button and the password is not valid or password and re-typed password does not match then border color becomes red
  ...
  // if the user clicked on the signup button then isClicked will be true and if the user's re-typed password is not blank then isReEnterdPasswordValid will also becomes true and if the password and retyped password also matches then doesPasswordAndReEnteredPasswordMatch becomes true.And Then if all of these three conditions satisfy then we change the border color to green
  ...
  // else if the user clicks on the signup button and the re-typed password is not valid then border color becomes red
        ...
        <form>
          ...
          <div className="mb-4">
            ...
            <div className='relative'>
              ...
              {/* if isCliked is true and isUserNameValid is true then we render the tick mark symbol svg */}
              {
          ...
          <div className="mb-4">
            ...
            <div className='relative'>
              ...
              {/* if isCliked is true , isPasswordValid is true and also doesPasswordAndReEnteredPasswordMatch is also true then we render the tick mark symbol svg */}
              {
            ...
            <div className='relative mb-8'>
              ...
              {/* if isCliked is true and isPasswordValid is true and doesPasswordAndReEnteredPasswordMatch becomes false then we render the "Passwords do not match" paragraph */}
          ...
          <div className="mb-4">
            ...
            <div className='relative'>
              ...
              {/* if isCliked is true, isReEnterdPasswordValid is true and also doesPasswordAndReEnteredPasswordMatch is true then we render the tick mark symbol svg */}
              {
            ...
            <div className='relative mb-8'>
              ...
              {/* if isCliked is true and isReEnterdPasswordValid is false then we render the "Re-entered Password Must not be blank" paragraph */}
              ...
              {/* if isCliked is true and isReEnterdPasswordValid is true and doesPasswordAndReEnteredPasswordMatch becomes false then we render the "Passwords do not match" paragraph */}
